    ...
    <>
      ...
      >
        <Card className="h-full border-0 rounded-none bg-transparent">
          <CardHeader className="sticky top-0 bg-white/90 dark:bg-gray-900/90 z-10 border-b border-primary-aqua/20 shadow-sm">
          ...
          <CardContent className="space-y-8 py-8 px-4">
            {/* Categories */}
            {categories.length > 0 && (
              <div>
                <Label className="text-lg font-semibold mb-4 block text-primary-aqua">Category</Label>
                  ...
                  {categories.map((category) => (
                    <div key={category.id} className="flex items-center space-x-2 group hover:bg-primary-aqua/5 rounded-lg px-2 py-1 transition-colors">
                      <Checkbox
                        ...
                        className="accent-primary-aqua focus:ring-2 focus:ring-primary-aqua"
                      />
                      <Label 
            ...
            {/* Price Range */}
            <div>
              <Label className="text-lg font-semibold mb-4 block text-primary-aqua">Price Range</Label>
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-full rounded-lg border border-primary-aqua/30 focus:border-primary-aqua focus:ring-2 focus:ring-primary-aqua"
                />
                <Input
                  type="number"
                  placeholder="Max"
            ...
            {/* Condition */}
            <div>
              <Label className="text-lg font-semibold mb-4 block text-primary-aqua">Condition</Label>
