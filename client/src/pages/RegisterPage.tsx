  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      if (error === "google_auth_failed") {
        errorMessage = "Google authentication failed. Please try again or use email/phone registration.";
      } else if (error === "facebook_auth_failed") {
        errorMessage = "Facebook authentication failed. Please try again or use email/phone registration.";
      }
        ...
        <div className="min-h-screen flex items-center justify-center p-2 sm:p-4 md:p-6">
          ...
          <div className="w-full max-w-lg space-y-3 sm:space-y-6 relative z-10 my-4 sm:my-8">
            <Card className="shadow-2xl border-2 border-white/50 overflow-hidden backdrop-blur-xl bg-white/90 rounded-xl sm:rounded-2xl transform transition-all duration-300 hover:shadow-3xl">
              <CardHeader className="relative space-y-0 sm:space-y-3 text-center text-white rounded-t-xl sm:rounded-t-2xl py-6 px-4 sm:px-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(188, 100%, 29%) 0%, hsl(188, 100%, 26%) 50%, hsl(188, 79%, 38%) 100%)' }}>
                {/* Decorative elements */}
              ...
              <CardContent className="p-4 sm:p-8">
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-white px-3 text-gray-500 font-semibold">Or sign up with</span>
                    </div>
                  </div>
                ...
                <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className=" px-3 text-gray-500 font-semibold">Already a member?</span>
