...
- June 16, 2025. Replaced all website imagery with user-provided custom book photo - updated hero section background images, About section photos, and category display images throughout homepage to use single consistent uploaded image, creating unified visual branding and personalized bookstore atmosphere with authentic A2Z BOOKSHOP imagery.
```
