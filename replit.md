...
- June 22, 2025. Fixed "Special Gift Offer" text arrangement in mobile view - reduced font sizes significantly for mobile (text-lg for heading, text-base for description) to ensure complete text visibility without horizontal scrolling, desktop view remains unchanged with large text sizes, mobile users can now see full gift offer text without any scrolling required.
```
