...
- June 18, 2025. Configured production SMTP with user's Zoho Mail credentials - updated email service to use orders@a2zbookshop.com via smtp.zoho.com:587 (TLS), implemented direct credential configuration for reliable email delivery, updated all email functions to use production settings, added admin panel display showing both TLS (587) and SSL (465) port options for complete SMTP transparency.
```
